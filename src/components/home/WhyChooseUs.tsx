    ...
    <section className="hidden md:block py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-gray-700 mb-12 max-w-4xl mx-auto text-center">
          SamuiWater.com delivers TFDA-approved bottled water across Koh Samui. Order in English, pay securely, and enjoy fast delivery to your hotel, villa or condo. Our English-speaking team ensures a flawless experience.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-blue-50 p-6 rounded-lg text-center">
            ...
            <p className="text-gray-700">
              Every bottle is sourced from TFDA-approved brands, ensuring pure, clean water for drinking, cooking, or travel.
            </p>
          </div>
